import {
  require_react_dom
} from "/build/_shared/chunk-TZUJ7GY4.js";
import {
...
var Portal = /* @__PURE__ */ React3.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(/* @__PURE__ */ React3.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(React3.Fragment, {
      children
    });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(React3.Fragment, {
...
var Modal = /* @__PURE__ */ React4.forwardRef(function Modal2(props, forwardedRef) {
...
var TextareaAutosize = /* @__PURE__ */ React5.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
...
var FormControlContext = /* @__PURE__ */ React15.createContext(void 0);
if (true) {
...
var InputBase = /* @__PURE__ */ React18.forwardRef(function InputBase2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(React18.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
...
var Backdrop = /* @__PURE__ */ React21.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(TransitionComponent, _extends({
    ...
    children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
var Button = /* @__PURE__ */ React23.forwardRef(function Button2(inProps, ref) {
  ...
  const startIcon = startIconProp && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp
  });
  const endIcon = endIconProp && /* @__PURE__ */ (0, import_jsx_runtime23.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp
  });
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsxs)(ButtonRoot, _extends({
    ownerState,
...
var Modal3 = /* @__PURE__ */ React24.forwardRef(function Modal4(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(Modal_default, _extends({
    slots: {
      root: RootSlot,
...
var FormControl = /* @__PURE__ */ React26.forwardRef(function FormControl2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormControl"
  });
...
var FormHelperText = /* @__PURE__ */ React27.forwardRef(function FormHelperText2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormHelperText"
  });
...
var FormLabel = /* @__PURE__ */ React28.forwardRef(function FormLabel2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormLabel"
  });
...
var Input = /* @__PURE__ */ React30.forwardRef(function Input2(inProps, ref) {
  var _ref, _slots$root, _ref2, _slots$input;
  const props = useThemeProps({
    props: inProps,
    name: "MuiInput"
...
var InputLabel = /* @__PURE__ */ React31.forwardRef(function InputLabel2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime32.jsx)(InputLabelRoot, _extends({
    "data-shrink": shrink,
    ownerState,
    ref,
    className: clsx_m_default(classes.root, className)
...
var ListContext = /* @__PURE__ */ React32.createContext({});
if (true) {
...
var List = /* @__PURE__ */ React33.forwardRef(function List2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiList"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(ListContext_default.Provider, {
    value: context,
    children: /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)(ListRoot, _extends({
      as: component,
      className: clsx_m_default(classes.root, className),
      ref,
      ownerState
...
var MenuList = /* @__PURE__ */ React34.forwardRef(function MenuList2(props, ref) {
  const {
    // private
    // eslint-disable-next-line react/prop-types
    actions,
  ...
  const items = React34.Children.map(children, (child, index) => {
    if (index === activeItemIndex) {
      ...
      return /* @__PURE__ */ React34.cloneElement(child, newChildProps);
    }
    return child;
  });
  return /* @__PURE__ */ (0, import_jsx_runtime35.jsx)(List_default, _extends({
    role: "menu",
    ref: handleRef,
    className,
    onKeyDown: handleKeyDown,
...
var Popover = /* @__PURE__ */ React35.forwardRef(function Popover2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPopover"
  });
...
var _excluded25 = ["autoFocus", "children", "disableAutoFocusItem", "MenuListProps", "onClose", "open", "PaperProps", "PopoverClasses", "transitionDuration", "TransitionProps", "variant"];
var RTL_ORIGIN = {
  vertical: "top",
  horizontal: "right"
};
...
var Menu = /* @__PURE__ */ React36.forwardRef(function Menu2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMenu"
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime37.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
...
var NativeSelectInput = /* @__PURE__ */ React37.forwardRef(function NativeSelectInput2(props, ref) {
  const {
    className,
    disabled,
    error,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime39.jsxs)(React37.Fragment, {
...
function NotchedOutline(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(NotchedOutlineRoot, _extends({
    "aria-hidden": true,
    className,
    ownerState
  }, other, {
    children: /* @__PURE__ */ (0, import_jsx_runtime40.jsx)(NotchedOutlineLegend, {
      ownerState,
      children: withLabel ? /* @__PURE__ */ (0, import_jsx_runtime40.jsx)("span", {
        children: label
      }) : (
        // notranslate needed while Google Translate will not fix zero-width space issue
...
var OutlinedInput = /* @__PURE__ */ React39.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(InputBase_default, _extends({
    slots: {
      root: RootSlot,
      input: InputSlot
    },
    renderSuffix: (state) => /* @__PURE__ */ (0, import_jsx_runtime42.jsx)(NotchedOutlineRoot2, {
      ownerState,
      className: classes.notchedOutline,
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = /* @__PURE__ */ (0, import_jsx_runtime41.jsxs)(React39.Fragment, {
        children: [label, "\u2009", "*"]
      })) : label,
...
var _span3;
var _excluded29 = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "error", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"];
...
var SelectInput = /* @__PURE__ */ React40.forwardRef(function SelectInput2(props, ref) {
  const {
    "aria-describedby": ariaDescribedby,
  ...
  const items = childrenArray.map((child) => {
    ...
    return /* @__PURE__ */ React40.cloneElement(child, {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(React40.Fragment, {
    children: [/* @__PURE__ */ (0, import_jsx_runtime43.jsx)(SelectSelect, _extends({
    ...
    })), /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      className: classes.icon,
      ownerState
    }), /* @__PURE__ */ (0, import_jsx_runtime43.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
var Select = /* @__PURE__ */ React41.forwardRef(function Select2(inProps, ref) {
  const props = useThemeProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(React41.Fragment, {
    children: /* @__PURE__ */ React41.cloneElement(InputComponent, _extends({
...
var TextField = /* @__PURE__ */ React42.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(InputComponent, _extends({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime47.jsxs)(TextFieldRoot, _extends({
    className: clsx_m_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && /* @__PURE__ */ (0, import_jsx_runtime46.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    motion.form,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button_default, { variant: "contained", children: "Entrar" }, void 0, false, {
          fileName: "app/routes/_auth.login.tsx",
          lineNumber: 37,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { children: "N\xE3o tem uma conta?" }, void 0, false, {
          fileName: "app/routes/_auth.login.tsx",
          lineNumber: 38,
          columnNumber: 13
        }, this),
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to: "/register", children: "Cadastre-se agora!" }, void 0, false, {
          fileName: "app/routes/_auth.login.tsx",
          lineNumber: 39,
          columnNumber: 13
        }, this)
...
@mui/material/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/routes/_auth.login-Z3L33Z4H.js.map
